...
/*   $consulta=mysql_query("SELECT tiras.cod_comic, tiras.titulo, tiras.fecha_publicacion, SUM(visitas.num_visitas) AS total_visitas, 
   ...
   $consulta=mysql_query("SELECT visitas.fecha, SUM(visitas.num_visitas) AS total_visitas 
                                FROM visitas
						 WHERE (visitas.cod_comic = '$cod_comic')
  ...
  $contador_color=0; // este contador permitira darle la alternabilidad a los colores	
   ...
   $consulta_max=mysql_query("SELECT MAX(visitas.num_visitas) AS maximo_visitas 
                              FROM visitas
						      WHERE (visitas.cod_comic = '$cod_comic')",$link) or die(mysql_error()); 
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr class="encabezado_formularios">
    <td colspan="2">Estad&iacute;sticas  Diarias Para el Comic <?php echo $cod_comic;?></td>
  </tr>
  <tr class="encabezado_formularios">
